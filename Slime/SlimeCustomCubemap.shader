...
Shader "Dafirex/Slime/Custom Cubemap"
{
	Properties
	{
		_Color ("Color", Color) = (1, 1, 1, 1)
		_CubeMap("Cube Map", CUBE) = "white" {}
		_CubeColor("Cubemap Color", Color) = (1, 1, 1, 1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				half4 skyData = texCUBE(_CubeMap, i.worldRefl + distort * _SkyDistort) * _CubeColor;
				half3 skyColor = skyData * _SkyWeight;
